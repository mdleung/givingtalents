    ...
    <nav class="glass-morphism shadow-lg">
            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="{{ route('admin.index') }}" class="text-purple-deep hover:text-purple-brand px-3 py-2 rounded-md text-sm font-medium transition-colors">
                            Admin
                        </a>
                    </div>
                </div>
        ...
        <div id="mobile-menu" class="md:hidden hidden">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white/10">
                ...
                <a href="{{ route('admin.index') }}" class="text-purple-deep hover:text-purple-brand block px-3 py-2 rounded-md text-base font-medium">
                    Admin
                </a>
            </div>
        </div>
